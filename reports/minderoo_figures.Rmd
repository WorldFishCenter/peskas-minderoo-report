...
landings %>%
  ...
  geom_vline(xintercept = as.numeric(as.Date("2020-06-01")),size=1,color="#1a4985",linetype=6)+
  scale_x_date(date_breaks = "3 month", minor_breaks = NULL, labels = label_date, limits = set_date_limits) +
  ggthemes::scale_fill_tableau("Miller Stone", name = NULL,direction=1) +
  theme_minimal()  +
  labs(x = "", y = "Gear type usage (%)",
       title = "Relative usage of <strong>gear type  has been stable </strong> during the <span style='color:#1a4985;'>reporting period</span>",
...
landings %>%
  ...
  labs(x = "", y = "Exploited habitat (%)",
       title = "<strong>Deep habitat was more explited </strong> during the <span style='color:#1a4985;'>reporting period</span>",
